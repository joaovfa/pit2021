            ...
            <div class="container px-5">
                ...
                <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                    <div class="text-center mb-5">
                        <div id="botaoi" class="feature bg-gradient text-white rounded-3 mb-3"><i
                        ...
                        <div class="col-lg-8 col-xl-6">
                            ...
                            <form form action="" method="post" id="contactForm" data-sb-form-api-token="API_TOKEN">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="name" type="text" name="nome" placeholder="Enter your name..." data-sb-validations="required" />
                                ...
                                <!-- Phone number input-->
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="phone" type="tel" name="telefone" placeholder="(123) 456-7890" data-sb-validations="required" />
                                    <label for="phone">Telefone celular</label>
                                    <div class="invalid-feedback" data-sb-feedback="phone:required">A phone number is required.</div>
                                </div>
                                <!-- Message input-->
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" id="message" type="text" name="mensagem" placeholder="Enter your message here..." style="height: 10rem" data-sb-validations="required"></textarea>
